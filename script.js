...
function populateTable() {
    ...
    students.forEach(function (student) {
        ...
        row.insertCell(1).innerHTML = `<img src="${student.img_src}" alt="Student Image"> ${student.first_name} ${student.last_name}`;
        row.insertCell(2).textContent = student.gender;
        row.insertCell(3).textContent = student.marks;
        row.insertCell(4).textContent = student.passing ? "Pass" : "Fail";
...
function sortByMarks() {
    document.getElementById("classHeader").style.display="none";
    const sortmarks = students.sort((a, b) => {
...
function sortByClass() {
    document.getElementById("classHeader").style.display="table-cell";
...
function sortByGender() {
    document.getElementById("studentTable").getElementsByTagName("thead")[0].style.display = "none";
    ...
    const maleTable = createTable(maleStudents, "Male");
    const femaleTable = createTable(femaleStudents, "Female");
    const tableBody = document.getElementById("tableBody");
    tableBody.innerHTML = ""; 
    tableBody.appendChild(maleTable)+tableBody.appendChild(femaleTable);
}

function createTable(students, gender) {
    const table = document.createElement("table");
    const tableBody = document.createElement("tbody");
    const tableHeader = document.createElement("thead");
    const headerRow = document.createElement("tr");
    const headers = ["Id", "Name", "Gender", "Marks", "Passing", "Email"];
    ...
    table.id = gender.toLowerCase() + "Table";
...
function populateTable2(studentList) {
    const tableBody = document.getElementById("tableBody");
    tableBody.innerHTML = "";
